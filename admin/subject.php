...
?>      
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-cog"></i>subject Data</h3>
					<ol class="breadcrumb">
	 ...
	 <table id="myTable" class="display" cellspacing="0" width="100%">
		...
		?>
            <tr>
				...
				<td>
				<?php  echo("<a href='deletsubject.php?temp=".$fetch1['subject_id']."'>");
			...
			?>
				  ...
				  <div class="col-lg-5">
                      <section class="panel">
                          <header class="panel-heading">
                              subject Insert Forms
                          </header>
                          <div class="panel-body">
                              <form role="form" method="POST" action="subjectinsert.php" enctype="multipart/form-data">
                                  <div class="form-group">
                                      <label for="exampleInputEmail1">subject Name</label>
                                      <input type="text" class="form-control" name="comname"  maxlength="30" required id="exampleInputEmail1" placeholder="subject Name">
                                  </div>
