...
?>      
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header" style="color:red; font-size:40px; font-family:courier;"><i style="color:red; font-size:60px;" class="fa fa-cog"></i><b>Room Data</b></h3>
					<ol style="border:1px solid red;" class="breadcrumb">
						...
						<li style="color:red;" ><i class="icon_cogs"></i><a style="color:red; href="class.php">Room</a></li>
	 ...
	 <table style="background-image: url('images/atnd.png'); height:auto;   background-position: center; background-repeat: no-repeat;  background-size: cover; border:1px solid red; " id="myTable" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th style="color:black; border:1px solid red;" >Room Name</th>
		...
		?>
            <tr>
                <td style="background-color:lightyellow; border:1px solid red; color:black" ><?php echo($fetch1['room_id']);?></td>
                <td style="background-color:lightyellow; border:1px solid red; color:black" ><?php echo($fetch1['roomm']);?></td>
		
				<td style="background-color:lightyellow; border:1px solid red; color:black" >
				<?php  echo("<a href='delroom.php?temp=".$fetch1['room_id']."'>");
			...
			?>
				  ...
				  <div class="col-lg-5">
                     <section style="border:1px solid red;" class="panel">
                          ...
                          <div class="panel-body">
                              <form style=" background-image: url('images/atnd.png'); height:auto;   background-position: center; background-repeat: no-repeat;  background-size: cover; " id="myTable" class="display" cellspacing="0" width="100%" role="form" method="POST" action="room_insert.php" enctype="multipart/form-data">
                                  <div class="form-group">
                                      <label style="color:black; font-size:16px;" for="exampleInputEmail1">Room Name</label>
                                      <input type="text"  style="background-color:lightyellow" class="form-control" name="room"  maxlength="30" required id="exampleInputEmail1" placeholder="Room Name">
                                  </div>
