...
?>
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_cogs"></i><a href="shedule.php">schedule</a></li>
	 ...
	 <table id="myTable" class="display" cellspacing="0" width="100%">
		...
		echo $Semester_id = $fetch1['Semester_id'];
		...
		?>
            <tr>
			 <td><?php echo($fetch4['teacher_name']);?></td>
				...
				<td><img style="width:80px; height:50px;" src="<?php echo("images/".$fetch4['image']); ?>" ></td>
				</tr>
			<?php 
		}
			?>
