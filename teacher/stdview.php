...
?>      
      ...
      <section id="main-content">
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_cogs"></i><a href="student.php">Teacher</a></li>
		...
		$temp=$_GET['temp'];
		$query1= "SELECT * FROM student where student_id='".$temp."' ";
            ...
            <tr>
			 <td><?php echo($fetch1['student_reg_no']);?></td>
                <td><?php echo($fetch1['student_name']);?></td>
				 <td><?php echo($fetch1['student_password']);?></td>
				 <td><?php echo($fetch1['CNIC']);?></td>
				
                <td><?php echo($fetch1['address']);?></td>
				 <td><?php echo($fetch1['no']);?></td>
				
				<td>
				
				<img style="width:80px; height:50px;"  src="<?php echo("images/".$fetch1['image']); ?>" >
